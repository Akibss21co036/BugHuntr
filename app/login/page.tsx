...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      login(formData.email, formData.email, isAdminLogin ? "admin" : "user")
      router.push("/feed")
    } catch (error) {
        ...
        <Card className="border-slate-700 bg-slate-800/50 backdrop-blur-sm">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription className="text-slate-400">
              {isAdminLogin
                ? "Sign in to your admin account to manage bug hunts"
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button variant="outline" className="border-slate-600 bg-slate-700/50 text-white hover:bg-slate-700">
