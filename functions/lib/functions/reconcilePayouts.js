...
exports.reconcilePayouts = void 0;
 ...
 */
exports.reconcilePayouts = functions.pubsub
    ...
    try {
        ...
        const cryptomusPayouts = ((_a = cryptomusHistory.result) === null || _a === void 0 ? void 0 : _a.items) || [];
        ...
        for (const cryptomusPayout of cryptomusPayouts) {
            ...
            if (!firestorePayout) {
                ...
                // Compare statuses
                const cryptomusInternalStatus = (0, validation_1.mapCryptomusStatus)(cryptomusPayout.status);
                ...
                if (cryptomusInternalStatus !== firestoreStatus) {
                    ...
                    try {
                        await db.collection('payouts').doc(order_id).update({
                            ...
                            cryptomus_response: Object.assign(Object.assign({}, firestorePayout.cryptomus_response), { reconciliationUpdate: {
        ...
        await (0, firestore_1.createPayoutLog)({
            ...
            data: {
                ...
                hasDiscrepancies: discrepancies.missingInFirestore.length > 0 ||
        ...
        if (discrepancies.missingInFirestore.length > 0 ||
...
//# sourceMappingURL=reconcilePayouts.js.map